...
export default function Contact() {
    ...
    const handleSubmit = (e) => {
        ...
        const serviceid = 'service_la5pkrh';
        const templateid = 'template_nk1lblg';
        const publickey = 'azEVAMz_WSG9R3St1';
        ...
        .then((response) => {
            alert("Send Successful", response);
            setName('');
            setEmail('');
            SetMobile('');
            setMessage('');
        ...
        .catch((error) =>{
            alert("Error Sending Massage: ",error);

        });
    }

  return (
    <section className="relative -top-24 py-20 lg:py-[120px] h-[85vh]">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12  ">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              <span className="text-primary mb-4 block text-base font-semibold text-sky-400">
                Contact Us
              </span>
              ...
              <form onSubmit={handleSubmit} className="emailForm">
                <div className="mb-6">
                  <input
                    ...
                    className="text-body-color border-[f0f0f0] focus:border-primary w-full rounded border py-2 px-[14px] text-base outline-none focus-visible:shadow-none"
                    required
                  />
                </div>
                <div className="mb-6">
                ...
                <div className="mb-6">
                  <textarea
                    ...
                    className="text-body-color border-[f0f0f0] focus:border-primary w-full resize-none rounded border py-2 px-[14px] text-base outline-none focus-visible:shadow-none"
                    required
                  ></textarea>
                </div>
                <div>
                  <button
                    type="submit"
                    className="bg-primary border-primary w-full rounded border p-3 bg-sky-400 text-white transition hover:bg-opacity-90"
                  >
                    Send Message
                  </button>
                </div>
